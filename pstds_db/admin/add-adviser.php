        ...
        <div id="layoutSidenav_content">
            <main role="main">
                <div class="container-fluid px-4">
                    <h1 class="mt-5 h3" id="main-heading">Add Adviser</h1>
                    <ol class="breadcrumb mb-4" role="navigation" aria-label="Breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add Adviser</li>
                    </ol>
                    <section class="row" role="region" aria-labelledby="section-heading">
                        ...
                        <article class="col-md-12" role="article">
                            <div class="card mb-4" role="complementary">
                                <div class="card-body">
                                    <p class="mb-0" role="note">Fill in adviser details. Make sure to fill in the email address correctly.</p>
                                </div>
                            </div>
                            <!-- Form -->
                            <div class="card mb-4" role="complementary">
                                <div class="card-body">
                                    <form id="adviserForm" action="functions/process-add-adviser.php" method="POST" class="main-content" role="form">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <select id="subject-area" name="subject_area" class="form-select" role="combobox" required>
                                                        ...
                                                        <?php
                                                            include '../connect.php';
                                                            $query = "SELECT id, subject_area_name FROM tbl_subject_area"; // Get both id and name
                                ...
                                <div class="card-footer">
                                    <button type="submit" form="adviserForm" class="btn btn-primary"><i class="fas fa-plus"></i> Add</button>
                                </div>
                            </div>
                        </article>
                    </section>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="manage-adviser.php" class="btn btn-primary" role="button">View List</a>
                </div>
            </div>
        </div>
    </div>
