...
function buildAnnouncementQuery($conn, $filterType, $searchQuery, $isCount = false, $limit = null, $offset = null) {
    ...
    $baseQuery = "SELECT " . ($isCount ? "COUNT(*)" : "*") . " FROM tbl_announcement WHERE audience IN ('all', 'cooperating teacher') AND isDeleted = 0";
...
<head>
    ...
    <title>Announcements - Cooperating Teacher</title>
