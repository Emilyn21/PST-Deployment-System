...
$query = "SELECT tu.email, tu.profile_picture, tu.contact_number, tu.first_name, tu.middle_name, tu.last_name, 
            ...
            tsa.subject_area_name, tcs.school_name,
            CASE 
            ...
            tu.updated_at
          FROM tbl_user tu
          JOIN tbl_cooperating_teacher tct ON tu.id = tct.user_id
          JOIN tbl_subject_area tsa ON tct.subject_area_id = tsa.id
          JOIN tbl_school tcs ON tct.school_id = tcs.id
          WHERE tu.id = ?";
...
if ($stmt = $conn->prepare($query)) {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        $subject_area_name = $row['subject_area_name'];
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="mb-2">
                                        <strong>Name:</strong> 
                                        <span aria-label="Full name"><?= htmlspecialchars($ct_name); ?></span>
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <span aria-label="School"><?= htmlspecialchars($school_name); ?></span>
                                    </div>
                                    <div class="mb-3">
                                        <strong>Subject Area:</strong> 
                                        <span aria-label="Subject area"><?= htmlspecialchars($subject_area_name); ?></span>
                                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="updateProfileModalLabel"><i class="fas fa-edit"></i> Update Profile</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">
                    <form id="updateProfile" method="POST" enctype="multipart/form-data" action="functions/update-profile.php">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="<?= htmlspecialchars($email); ?>" aria-readonly="true" readonly disabled>
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first-name" name="first-name" placeholder="Enter First Name" value="<?= htmlspecialchars($first_name ?? ''); ?>" required aria-readonly="true">
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="middle-name">Middle Name:</label>
                                    <input type="text" class="form-control" id="middle-name" name="middle-name" placeholder="Enter Middle Name" value="<?= htmlspecialchars($middle_name ?? ''); ?>" aria-readonly="true">
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="last-name">Last Name:</label>
                                    <input type="text" class="form-control" id="last-name" name="last-name" placeholder="Enter Last Name" value="<?= htmlspecialchars($last_name ?? ''); ?>" required aria-readonly="true">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="birthdate" name="birthdate" value="<?= isset($birthdate) ?htmlspecialchars($birthdate): ''; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="street" name="street" placeholder="Enter Street" value="<?= htmlspecialchars($street ?? ''); ?>">
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    <label for="subject_area">School :</label>
                                    <input type="text" class="form-control" id="school" name="school" value="<?= htmlspecialchars($school_name ?? ''); ?>" readonly disabled aria-readonly="true">
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="subject_area">Subject Area:</label>
                                    <input type="text" class="form-control" id="subject-area" name="subject-area" value="<?= isset($subject_area_name) ? htmlspecialchars($subject_area_name):''; ?>" readonly disabled>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <button form="updateProfile" type="submit" class="btn btn-primary">Save Changes</button>
                </div>
            </div>
        </div>
    </div>
