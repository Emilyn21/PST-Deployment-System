...
$query = "SELECT tu.email, tu.profile_picture, tu.contact_number, tu.first_name, tu.middle_name, tu.last_name, 
            ...
            tu.updated_at
          FROM tbl_user tu
          JOIN tbl_adviser tadv ON tu.id = tadv.user_id
          JOIN tbl_subject_area tsa ON tadv.subject_area_id = tsa.id
          WHERE tu.id = ?";
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="mb-2">
                                        <strong>Name:</strong> 
                                        <span aria-label="Full name"><?= htmlspecialchars($adviser_name); ?></span>
                                    </div>
                                    <div class="mb-2">
        ...
        <div class="modal-dialog modal-lg" role="dialog" aria-modal="true">
            <div class="modal-content">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="middle-name" name="middle-name" placeholder="Enter First Name" value="<?= htmlspecialchars($middle_name ?? ''); ?>" aria-readonly="true">
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="last-name">Last Name:</label>
                                    <input type="text" class="form-control" id="last-name" name="last-name" placeholder="Enter First Name" value="<?= htmlspecialchars($last_name); ?>" required aria-readonly="true">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="subject-area" name="subject-area" value="<?= htmlspecialchars($subject_area_name ?? ''); ?>" readonly disabled aria-readonly="true">
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" aria-label="Save changes" form="updateProfile">Save changes</button>
                </div>
            </div>
        </div>
    </div>
