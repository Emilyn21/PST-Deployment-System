...
if ($semesterRow = $semesterResult->fetch_assoc()) {
    ...
    // Modify the SQL query to fetch only pre-service teachers assigned to the logged-in adviser
...
<head>
    ...
    <title>Assigned Pre-Service Teachers - Adviser</title>
...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <p class="mb-0" role="note">
                                You can view the pre-service teachers assigned to you and their assigned cooperating teacher below.
                            </p>
                        </div>
                    </div>
                    <!-- Data Table -->
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatablesSimple" class="table table-bordered" role="table" aria-label="Assigned Pre-Service Teachers Table">
                                <thead role="rowgroup">
                                    <tr role="row">
                                ...
                                <tbody role="rowgroup">
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr role="row">
                                            ...
                                            <td><?= htmlspecialchars($row['program_major']); ?></td>
    ...
    <script>
        ...
        function exportTableToCSV() {
            ...
            const headers = ["Student Number", "Pre-Service Teacher", "Program-Major", "Placement School", "Cooperating Teacher"];
        ...
        function printTable() {
            ...
            win.document.write('<thead><tr><th>Student Number</th><th>Pre-Service Teacher</th><th>Program - Major</th><th>Placement School</th><th>Cooperating Teacher</th></tr></thead><tbody>');
