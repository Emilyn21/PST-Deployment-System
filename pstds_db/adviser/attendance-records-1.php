...
<body class="sb-nav-fixed">
    ...
    <script>
        window.addEventListener('DOMContentLoaded', event => {
            ...
            if (datatablesSimple) {
                const dataTable = new simpleDatatables.DataTable(datatablesSimple, {
                    labels: {
                        noRows: "No pre-service teachers attendance yet."
                    }
                });
            }
        });
        ...
        function printTable() {
            ...
            win.document.write('<h2 style="margin-top: 0;">List of Attendance Records</h2>');
            win.document.write('<table>');
            win.document.write('<thead><tr><th>Date</th><th>Student Number</th><th>Name</th><th>Program - Major</th><th>Time In</th><th>Time Out</th></tr></thead><tbody>');
