...
function buildAnnouncementQuery($conn, $filterType, $searchQuery, $isCount = false, $limit = null, $offset = null) {
    ...
    $baseQuery = "SELECT " . ($isCount ? "COUNT(*)" : "*") . " FROM tbl_announcement WHERE audience IN ('all', 'pre-service teacher') AND isDeleted = 0";
...
<head>
    ...
    <title>Announcements - Pre-Service Teacher</title>
        ...
        <div id="layoutSidenav_content">
            <main> 
                <div class="container-fluid px-4">
                    <h1 class="mt-5 h3">Announcements</h1>
