...
$query = "SELECT 
            tu.email, tu.profile_picture, tu.contact_number, tu.first_name, tu.middle_name, tu.last_name, 
            TRIM(
                CONCAT(
                    tu.first_name, 
                    CASE 
            ...
            END AS address,
            CONCAT(
                COALESCE(tp.program_name, 'N/A'), 
                CASE 
                    WHEN tm.major_name IS NOT NULL THEN CONCAT('-', tm.major_name) 
                    ELSE '' 
                END
            ) AS program_major, 
            tp.program_name, 
          ...
          LEFT JOIN tbl_program tp ON tpst.program_id = tp.id
          LEFT JOIN tbl_major tm ON tpst.major_id = tm.id
          JOIN tbl_semester ts ON tpst.semester_id = ts.id
          LEFT JOIN tbl_academic_year tay ON ts.academic_year_id = tay.id
          LEFT JOIN tbl_placement tpl ON tpl.pre_service_teacher_id = tpst.id 
            AND tpl.status = 'approved' -- Ensure only approved placement is linked
            AND tpl.isDeleted = 0
          WHERE tu.id = ?";
...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="mb-2">
                                        <strong>Name:</strong> 
                                        <span aria-label="Full name"><?= htmlspecialchars($student_name); ?></span>
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <span aria-label="Program and major"><?= htmlspecialchars($program_major); ?></span>
                                    </div>
                                    <div class="mb-3">
                                        <strong>Academic year:</strong> 
                                        <span aria-label="Academic year"><?= htmlspecialchars($academic_year_name); ?></span>
                                    </div>
                    ...
                    if ($stmt = $conn->prepare($query)) {
                        ...
                        if ($row = $result->fetch_assoc()) {
                            $placement_update_time = !empty($row['date_approved']) ? date('M. j, Y, g:i A', strtotime($row['date_approved'])) : 'N/A';
                        }
                            ...
                            <ul>
                                ...
                                <li>Last login: <?= htmlspecialchars($last_login_time); ?></li>
                                    <?php if ($placement_status === 'approved'): ?>
                                        <li>Placement approved on <?= htmlspecialchars($placement_update_time); ?></li>
                                    <?php endif; ?>
                            </ul>
                        </div>
                    </section>
    ...
    <div class="modal fade" id="updateProfileModal" role="dialog" tabindex="-1" aria-labelledby="updateProfileModalLabel" aria-modal="true">
                ...
                <div class="modal-body">
                    <form id="updateProfileForm" method="POST" enctype="multipart/form-data" action="functions/update-profile.php" aria-labelledby="updateProfileModalLabel">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="program" name="program" value="<?= htmlspecialchars($program_name); ?>" readonly disabled>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="major">Major:</label>
                                    <input type="text" class="form-control" id="major" name="major" value="<?= htmlspecialchars($major_name ?? 'N/A'); ?>" readonly disabled>
                                </div>
                            </div>
                            <div class="col-md-4 mb-2">
                                <div class="col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="academic-year" name="academic-year" value="<?= htmlspecialchars($academic_year_name); ?>" readonly disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
                                    <label for="city_municipality">Municipality:</label>
                                    <input type="text" class="form-control" id="city_municipality" name="city_municipality" placeholder="Enter Municipality" value="<?= htmlspecialchars($city_municipality ?? ''); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-3 mb-2">
                                <div class="form-group">
